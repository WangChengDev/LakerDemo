...
import com.laker.lakerdemo.demo_flow.MainActivity;
...
public class EnterActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mTvBtnWechat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EnterActivity.this, com.laker.lakerdemo.demo_wechat.MainActivity.class));
            }
        });
        ...
        mTvBtnZhihu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EnterActivity.this, com.laker.lakerdemo.demo_zhihu.MainActivity.class));
            }
        });
    }
}
