...
class DateTimeWheel {
     ...
     */
    DateTimeWheel(View view, DateTimeScrollerConfig scrollerConfig) {
    ...
    private void initView(View view) {
        ...
        switch (mScrollerConfig.mDateType) {
            case ALL:
                Utils.showViews(mYearView,mMonthView, mDayView, mHourView, mMinuteView);
                break;
            case YEAR_MONTH_DAY:
                Utils.showViews(mYearView,mMonthView, mDayView);
                break;
            case YEAR_MONTH:
                Utils.showViews(mYearView,mMonthView);
                break;
            case MONTH_DAY_HOUR_MIN:
                Utils.showViews(mMonthView, mDayView, mHourView, mMinuteView);
                break;
            case HOURS_MINS:
                Utils.showViews(mHourView, mMinuteView);
                break;
            case YEAR:
    ...
    private void initYearView() {
        ...
        mYearAdapter = new NumericWheelAdapter(mContext, minYear, maxYear,
                DateConstants.FORMAT, mScrollerConfig.mYearUnit);
    ...
    private void updateMonths() {
        ...
        mMonthAdapter = new NumericWheelAdapter(mContext, minMonth, maxMonth,
                DateConstants.FORMAT, mScrollerConfig.mMonthUnit);
    ...
    private void updateDays() {
        ...
        int minDay = mRepository.getMinDay(curYear, curMonth);
        mDayAdapter = new NumericWheelAdapter(mContext, minDay, maxDay, DateConstants.FORMAT, mScrollerConfig.mDayUnit);
    ...
    private void updateHours() {
        ...
        mHourAdapter = new NumericWheelAdapter(mContext, minHour, maxHour, DateConstants.FORMAT, mScrollerConfig.mHourUnit);
    ...
    private void updateMinutes() {
        ...
        mMinuteAdapter = new NumericWheelAdapter(mContext, minMinute, maxMinute, DateConstants.FORMAT, mScrollerConfig.mMinuteUnit);
