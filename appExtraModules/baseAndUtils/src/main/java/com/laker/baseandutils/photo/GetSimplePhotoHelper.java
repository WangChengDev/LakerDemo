package com.laker.baseandutils.photo;
...
import com.laker.baseandutils.BitmapUtil;
...
public class GetSimplePhotoHelper {
    ...
    protected void getSelectedPhoto(Uri uri) {
        ...
        com.laker.baseandutils.photo.SimplePhoto photo = new SimplePhoto();
        photo.bitmap = bitmap;
        photo.uri = uri;
    ...
    public interface OnSelectedPhotoListener {
        ...
        public void onSelectedPhoto(int way, com.laker.baseandutils.photo.SimplePhoto photo);
