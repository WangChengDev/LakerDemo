...
package com.laker.dateandareasselecter.wheel;
...
import com.laker.dateandareasselecter.adapters.WheelViewAdapter;
import com.laker.dateandareasselecter.config.BaseScrollerConfig;
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    public void setConfig(BaseScrollerConfig config) {
