...
public class RxPermissions {
                        ...
                        .flatMap(new Function<List<Permission>, ObservableSource<Boolean>>() {
                            ...
                            public ObservableSource<Boolean> apply(List<Permission> permissions) throws Exception {
                                ...
                                for (Permission p : permissions) {
                                    Logger.e("33333333333333 permissions = "+p.toString());
                                    if (!p.granted) {
    ...
    private Observable<Permission> requestImplementation(final String... permissions) {
        ...
        for (String permission : permissions) {
            ...
            if (isGranted(permission)) {
                ...
                Logger.e("333333333333333 isGranted(permission) = "+isGranted(permission));
            ...
            if (isRevoked(permission)) {
                ...
                Logger.e("333333333333333 isRevoked(permission) = "+isGranted(permission));
    ...
    public boolean isGranted(String permission) {
        Logger.e("222222222222 isMarshmallow = "+isMarshmallow());
        Logger.e("222222222222 mRxPermissionsFragment.isGranted(permission) = "+mRxPermissionsFragment.isGranted(permission));
        Logger.e("222222222222 isGranted = "+(!isMarshmallow() || mRxPermissionsFragment.isGranted(permission)));
